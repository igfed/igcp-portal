							...
							function (success) {
								try {
									if (success !== null) {
										...
										sortedAccountObj[safeDealerName.toString()] = { "REGISTERED": success.previewItems };
									}
								} catch (err) {
									console.error(err);
								}
							...
							function (success) {
								try {
									if (success !== null) {
										...
										sortedAccountObj[safeDealerName.toString()]["UNREGISTERED"] = success.previewItems;
									}
								} catch (err) {
									console.error(err);
								}
