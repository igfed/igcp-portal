({
    initialize: function(component, event, helper) {
         ...
         console.log('Rory V2: controller: initialize');
    ...
    handleLogin: function (component, event, helpler) {
        ...
        debugger;
        console.log('Rory V2: controller: handlelogin');
    },
    ...
    setStartUrl: function (component, event, helpler) {
        ...
        console.log('Rory V2: controller: setStartUrl');
    },
    onKeyUp: function(component, event, helpler){
        ...
        console.log('Rory V2: controller: onKeyUp')
    },
    ...
    navigateToForgotPassword: function(cmp, event, helper) {
        ...
        console.log('Rory V2: controller: navigateToForgotPassword');
    },
    ...
    navigateToSelfRegister: function(cmp, event, helper) {
        ...
        $A.get("e.force:navigateToURL").setParams(attributes).fire();
        console.log('Rory V2: controller: navigateToSelfRegister');
    } 
})